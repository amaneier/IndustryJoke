...
function c1(k1) {
    ...
    if (k1 == 0) {
        ...
        c1c = 0;
        c2c = 0;
        change.innerHTML = "あなたは今高専にいます。<br>もっと勉強したいですか？";
    } else if (k1 == 1) {
        alert("工業高校に進みました！");
        c1c = 0;
        change.innerHTML = "あなたは今工業高校にいます。<br>もっと勉強したいですか？";
    }
}
...
function c2(k2) {
    ...
    if (k2 == 0) {
        ...
        c4c = 0;
        c5c = 0;
        change.innerHTML = "あなたは今工業大学にいます。<br>もっと勉強したいですか？";
    } else if (k2 == 1) {
        c10();
    }
}
...
function c4(k4) {
    ...
    if (k4 == 0) {
        ...
        c4c = 0;
        c5c = 0;
        change.innerHTML = "あなたは今専攻科にいます。<br>もっと勉強したいですか？";
    }
}
...
function c5(k5) {
    ...
    if (k5 == 0) {
        ...
        c6c = 0;
        c7c = 0;
        change.innerHTML = "あなたは今修士課程にいます。<br>もっと勉強したいですか？";
    } else if (k5 == 1) {
        c10();
    }
}
...
function c6(k6) {
    ...
    if (k6 == 0) {
        ...
        c5c = 0;
        c6c = 0;
        change.innerHTML = "あなたは修士課程にいます。<br>もっと勉強したいですか？";
    } else if (k6 == 1) {
        c10();
    }
}
...
function c7(k7) {
    ...
    if (k7 == 0) {
        ...
        c6c = 0;
        c7c = 0;
        change.innerHTML = "あなたは今博士課程にいます。<br>もっと研究したいですか？";
    } else if (k7 == 1) {
        c10();
    }
}
...
function c9() {
    ...
    setTimeout(function () {
        change.innerHTML = "研究を頑張ってるのに芽が出ない…<br>このままだと大学に残れない…";
    }, 1000);
...
function c10() {
    ...
    setTimeout(function () {
        change.innerHTML = "大きな会社に就職できた！！<br>ここは安寧の地！！！";
    }, 1000);
    setTimeout(function () {
